...
public class Eleição {
  public static void main(String[] args) {
	   ...
	   System.out.println("Qual é o total de votos para " + nomeDoPrimeiroCandidato + ": ");
	   totalDeVotosParaJunior = leitor.nextInt();
	   
	   System.out.println("Qual é o total de votos para " + nomeDoSegundoCandidato + ": ");
	   totalDeVotosParaMarco = leitor.nextInt();
	   
	   System.out.println("Qual é o total de votos para " + nomeDoTerceiroCandidato + ": ");
	   totalDeVotosParaLauro = leitor.nextInt();
	   
	   System.out.println("Qual é o total de votos nulos ");
	   totalNulos = leitor.nextInt();
	   
	   System.out.println("Qual é o total de votos Brancos ");
